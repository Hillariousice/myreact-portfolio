  ...
  return (
    <div className={`${darkMode ? "dark" : ""} min-h-screen flex flex-col dark:bg-gray-900`}>
      ...
      <main id="home" className="flex-grow bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section id="about-me" className="min-h-screen">
          ...
          <div className="relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 overflow-hidden md:h-96 md:w-96">
            {/* Added missing alt attribute and updated to modern Next13 Image standard */}
            <Image src={deved} fill style={{ objectFit: "cover" }} alt="Hillary Okporka" />
          </div>
        </section>
      ...
      <section id="tech-stack" className="py-10">
        <h3 className="text-3xl py-1 text-center text-gray-700 dark:text-white">My Tech Stack</h3>
